<template>
  <div v-if="trackTask" class="trackTask-continer">
...
export default {
  ...
  computed: {
    ...mapState({
      showView: function (state) {
        return state.business.tools.showView
      },
      trackTask: function (state) {
        return state.business.tools.trackTask
      },
      polylineLayer: function (state) {
        return state.business.map.polylineLayer
      }
    })
  },
  methods: {
